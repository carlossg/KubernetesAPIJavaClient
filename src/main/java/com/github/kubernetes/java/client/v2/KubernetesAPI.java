...
public interface KubernetesAPI {
    ...
    @Path("/pods/{podId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Status deletePod(@PathParam("podId") String podId) throws KubernetesClientException;
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    public ReplicationController getReplicationController(@PathParam("controllerId") String controllerId)
            throws KubernetesClientException;
    ...
    @Path("/replicationControllers/{controllerId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Status updateReplicationController(@PathParam("controllerId") String controllerId, int replicas)
            throws KubernetesClientException;
    ...
    @Path("/replicationControllers/{controllerId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public ReplicationController updateReplicationController(@PathParam("controllerId") String controllerId,
    ...
    @Path("/replicationControllers/{controllerId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Status deleteReplicationController(@PathParam("controllerId") String controllerId)
            throws KubernetesClientException;
    ...
    @Path("/services/{serviceId}")
    @Consumes(MediaType.APPLICATION_JSON)
    public Status deleteService(@PathParam("serviceId") String serviceId) throws KubernetesClientException;
